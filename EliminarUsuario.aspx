<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EliminarUsuario.aspx.cs" Inherits="ConsultarUsuario" %>
...
<body>
  ...
  <tr>
    <th class="auto-style2">
        ...
        <h2 align="center" class="auto-style6">ELIMINAR USUARIO</h2> 
  ...
  <tr>
    ...
    <th><asp:Label ID="lblUsuario" runat="server" Text=""></asp:Label></th>
          ...
          <asp:Button ID="eliminarUsuario1" runat="server" Text="ELIMINAR USUARIO" class="button button1" OnClick="eliminarUsuario1_Click" />
        </div>
        </th>
    </form>
</body>
