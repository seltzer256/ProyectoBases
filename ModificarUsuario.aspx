<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModificarUsuario.aspx.cs" Inherits="CrearUsuario" %>
...
<body>
  ...
  <tr>
    ...
    <th class="auto-style3">
        ...
        <h2 align="center" class="auto-style6">MODIFICAR USUARIO</h2> 
    ...
    <th class="auto-style3">
        ...
        <asp:Button ID="buscarUsuario" runat="server"  Text="BUSCAR USUARIO" />
          </th>
    </tr>
    <tr>
    <th>
  ...
  <tr>
    ...
    <th>
        <div align="center">
             <asp:Button ID="crearUsuario2" runat="server" class="button button1" Text="MODIFICAR USUARIO" />
